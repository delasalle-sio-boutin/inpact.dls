	        ...
	        <nav class="navbar navbar-fixed-top">
	            <div class="container" >
	                <div class="navbar-header">
	                    ...
	                    <a href="VueAccueil.php" class="navbar-brand"><img src="../images/logo.png" style="width: 95px; height: 50px; margin-top: -5px;"></a>
	                </div>
	                <div id="navbar" class="navbar-collapse collapse" style="padding-top:6px;">
	                    <ul class="nav navbar-nav">
	                        <li><a href="VueAccueil.php" class="dropdown-toggle active" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" style="border-top: #000 solid 1px; margin-top: -14px; padding-top: 28px">Accueil</a></li>
	                        <li class=" dropdown">
	                        ...
	                        <li class=" dropdown"><a href="#" class="dropdown-toggle active" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Liens utiles <span class="caret"></span></a>
	                            <ul class="dropdown-menu">
	                    ...
	                    <ul class="nav navbar-nav pull-right">
	                        <li><a href="#">Connecté en tant que</a></li>
