  ...
  <div id="page">
    ...
    <div id="main">
		...
		<?php
			...
			$query=$db->prepare('SELECT cat_id, cat_nom, forum_forum.forum_id, forum_name, forum_desc, forum_post, forum_topic, auth_view, forum_topic.topic_id,  forum_topic.topic_post, post_id, post_time, post_createur, membre_pseudo, 
			membre_id 
...
?>
		...
		echo'<p>Le nombre de messages est <strong>'.$totaldesmessages.'</strong>.<br />';
		echo'Le site et comptent <strong>'.$TotalDesMembres.'</strong> membres.<br />';
